import{G as _e}from"./lil-gui.esm-hsJpI9MV.js";import{M as c,S as Me,B as Se,U as be,a as J,V as ne,T as xe,b as g,R as a,c as ye,G as se,d as _,C as ke,P as ie,e as Te,A as Pe,D as Ee,f as I,g as Re,O as ze,W as Ce,h as Ae,F as Be,i as Le}from"./OrbitControls-CPGdEF21.js";class O extends c{constructor(){const e=O.SkyShader,N=new Me({name:e.name,uniforms:be.clone(e.uniforms),vertexShader:e.vertexShader,fragmentShader:e.fragmentShader,side:Se,depthWrite:!1});super(new J(1,1,1),N),this.isSky=!0}}O.SkyShader={name:"SkyShader",uniforms:{turbidity:{value:2},rayleigh:{value:1},mieCoefficient:{value:.005},mieDirectionalG:{value:.8},sunPosition:{value:new ne},up:{value:new ne(0,1,0)}},vertexShader:`
